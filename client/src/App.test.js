...
// Snapshot test:
// Component doesn't change its output.
// Once it changes the output, you have to decide if you accept the changes.
// Otherwisde you have to fix the component when the output is not the desired output.
